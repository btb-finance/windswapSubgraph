...
![WindSwap](https://img.shields.io/badge/WindSwap-v3.0.0-blue)
...
```
https://api.goldsky.com/api/public/project_cmjlh2t5mylhg01tm7t545rgk/subgraphs/windswap/v3.0.0/gn
```

### Dashboard
https://app.goldsky.com/project_cmjlh2t5mylhg01tm7t545rgk/dashboard/subgraphs/windswap/v3.0.0
...
# Deploy to GoldSky
goldsky subgraph deploy windswap/v3.0.0 --path .
```
